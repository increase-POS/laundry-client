...
namespace WPFTabTip
{
    public static class TabTipAutomation
    {
        ...
        public static void AutomateTabTipClose(IObservable<Tuple<UIElement, bool>> focusObservable, Subject<bool> tabTipClosedSubject)
        {
            focusObservable
        ...
        internal static void AutomateTabTipClose<T>(bool v)
        {
